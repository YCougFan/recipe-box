            ...
            <Modal show={onShow} onHide={this.handleCancel}>
                ...
                <Modal.Body>
                    <FormGroup controlId="formControlsName">
                        ...
                        <FormControl type="text" required onChange={this.handleRecipeNameChange} value={this.state.name}
                    ...
                    <FormGroup controlId="formControlsIngredients">
                        ...
                        <FormControl componentClass="textarea" type="text" required
                                     onChange={this.handleRecipeIngredientsChange} value={this.state.ingredients}
